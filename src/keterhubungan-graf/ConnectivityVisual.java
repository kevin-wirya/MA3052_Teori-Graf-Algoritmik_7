...
public class ConnectivityVisual extends JFrame {
    private GraphPanel graphPanel;
    
    public ConnectivityVisual(ArrayList<ArrayList<Integer>> adj, ArrayList<Integer> dfsTraversal, boolean isConnected) {
        setTitle("Visualisasi Keterhubungan Graf - " + (isConnected ? "TERHUBUNG (Ya)" : "TIDAK TERHUBUNG (Tidak)"));
        ...
        String resultText = "Hasil: " + (isConnected ? "GRAF TERHUBUNG (Ya)" : "GRAF TIDAK TERHUBUNG (Tidak)");
