      ...
      <header className="flex items-center justify-between px-5 py-3 bg-panel border border-border rounded-2xl shadow-panel shrink-0">
        <div>
          <h1 className="text-base font-bold text-accent tracking-tight flex items-center gap-2">
            ...
            <span className="text-[10px] bg-accent/10 text-accent font-semibold px-2 py-0.5 rounded-full uppercase tracking-wider">v1.2</span>
          </h1>
        ...
        <div className="text-right flex flex-col items-end">
          ...
          <span className="text-[10px] text-inkMuted font-mono mt-0.5">Kelompok 8</span>
        </div>
      </header>
